			...
			<div className="min-w-0 flex-1">
				...
				{hasContent && (
					<div className="mb-3 max-w-[92%] text-sm leading-7 text-slate-800">
						<MarkdownRenderer
							content={content}
							className="prose prose-slate prose-sm max-w-none prose-p:my-1.5 prose-ul:my-1.5 prose-ol:my-1.5 [&_:not(pre)>code]:rounded [&_:not(pre)>code]:bg-slate-100 [&_:not(pre)>code]:px-1.5 [&_:not(pre)>code]:py-0.5 [&_:not(pre)>code]:font-medium [&_:not(pre)>code]:text-slate-800"
