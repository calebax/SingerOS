...
export const skillMarketplaceApi = {
	...
	install: (params: InstallSkillParams) =>
		apiClient.post<BackendDataResponse<InstallSkillResponse>>("/skill-marketplace/install", params),
	...
	import: (params: ImportSkillParams) =>
		apiClient.post<BackendDataResponse<ImportSkillResponse>>("/skill-marketplace/import", params),
	...
	listRecentUsed: (limit?: number) =>
		apiClient.get<BackendDataResponse<SkillInstalledItem[]>>("/skills/recent", {
