...
func (r *UsageReporter) Report(ctx context.Context, record *CallRecord) {
	...
	payload := usageReportPayload{
		...
		OutToken:      record.OutToken,
		CacheHitToken: record.CacheHitToken,
		CacheMissToken: record.CacheMissToken,
...
type usageReportPayload struct {
	...
	OutToken      int64     `json:"out_token"`
	CacheHitToken int64     `json:"cache_hit_token"`
	CacheMissToken int64    `json:"cache_miss_token"`
